...
logout			                                | exit out of Web-1 back to Jump-box
...
logout			                                | exit ELK VM back to Jump-Box
...
http://(ELK-PublicIP:5601/app/kibana         |	Open web browser and navigate to logs | add log data | system logs click on check data. click on system logs dashboard.
...
http://(ELK-PublicIP:5601/app/kibana	        |	Open web browser and navigate to metric data | docker metrics | click on teh check data, click on Docker Metric dashboard
